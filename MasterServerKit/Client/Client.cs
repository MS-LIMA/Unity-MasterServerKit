    ...
    public partial class MasterServerKit
    {
        public class Client
        {
            ...
            public static void ConnectToMaster(string uuid = "")
            {
                ...
                string ip = MskConfigClient.Ip;
                ushort port = MskConfigClient.Port;

                if (MskConfigClient.IsIpDomain)
                {
            ...
            public static void OnPlayerNicknameUpdated(MskSocket client, Packet packet)
            {
                int clientId = packet.ReadInt();
            ...
            public static void OnPlayerCustomPropertiesUpdated(MskSocket client, Packet packet)
            {
                int clientId = packet.ReadInt();
